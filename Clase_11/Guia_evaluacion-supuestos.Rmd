---
title: "Guia clase 11 - Evaluación de supuestos análisis paramétricos"
...
Luego guarde inmediatamente su *script* como **script_8_nombre_apellido.Rmd**. Al finalizar la actividad deberá exportar y almacenar este script en su carpeta drive de tareas.
...
p <-  ggplot(tilapia_cepas, aes(x=Peso))
...
Harvey_dat %>%
  ggplot(aes(x=Weight, color=Ploidy)) +

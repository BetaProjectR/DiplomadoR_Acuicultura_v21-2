---
title: "Clase 17 Introducción a Modelos Lineales Generales"
...
```{r}
anova(mod_nulo, test ='Chisq')%>% kable()

anova(mod_logit, test ='Chisq')%>% kable()

anova(mod_logit_mult, test ='Chisq')%>% kable()

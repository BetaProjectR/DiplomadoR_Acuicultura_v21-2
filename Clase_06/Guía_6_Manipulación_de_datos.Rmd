---
title: "Clase 06 - Guía manipulación de datos con dplyr"
...
Luego, guarde inmediatamente su script como **script_6_nombre_apellido.Rmd**. Al finalizar la actividad deberá exportar y almacenar este **_script_** en su carpeta drive de tareas.
...
```{r}
Table_ovas <- ovas %>% group_by(Year) %>% summarise(mean = mean(ProdNac), sd = sd(ProdNac), n=n())

...
**Identificar conceptos importantes para realizar un análisis exploratorio de datos.**
...
*Responda en el documento compartido llamado Clase 5 Actividad
de aprendizaje disponible en el Drive del curso.*

## ESTUDIOS DE CASO.

**Identificar información relevante para realizar un análisis exploratorio de datos.**

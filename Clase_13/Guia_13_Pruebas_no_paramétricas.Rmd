...
Usando lo aprendido en el curso elabore y configure un archivo o file con extensión **.Rmd** y configurelo para exportar el resultado como un documento dinámico **pdf**.
...
Luego guarde inmediatamente su *script* como **script_13_nombre_apellido.Rmd**. Al finalizar la actividad deberá exportar y almacenar este script en su carpeta drive de tareas.

### **Ejercicio 2.** Configuración del reporte.

En el primer bloque de códigos o **chunk** configure los comandos de la siguiente manera **_knitr::opts_chunk$set(echo = TRUE)_** y cargue las librerías  **readxl**, **stats**, **ggplot2**.
...
En el siguiente experimento se desea evaluar si el tamaño de los peces puede asociarse de forma positiva o negativa con el número de parasitos.
...
En el siguiente experimento se desea evaluar si dos sensores de temperatura colocados a ambos extremos de una piscina de cultivo márcan la misma temperatura. Se sugiere aplicar el test de wilcoxon para muestras pareadas en atención a que ambos grupos provienen de la misma piscina y de los mismos días.

```{r, fig.cap="Temperatura de dos sensores en una piscina de cultivo"}
...
En el siguiente experimento se desea evaluar el efecto de 3 diferentes medios de cultivo (NUTRI: Nutrilake; GUILL Guillard; MONO: Monoammonuim Phosphate) sobre el tiempo medio generacional de la microalga *Chaetoceros muelleri* como alimento para la producción de copépodos.
...
# H0 : El Tiempo generacional de Chaetoceros muelleri no es diferente entre 3 medios cultivo: NUTRI, GUILL, MONO.
# HA :  El Tiempo generacional de Chaetoceros muelleri es diferente entre 3 medios cultivo: NUTRI, GUILL, MONO.
